  ...
  [% expect{|
    (@1
     (OrderIndependent
      ((@1
        (BoundDeclaration
         ((type_expr ((@1 (Type Bool)))) (name a)
          (init_expr ((@1 (BoolLiteral true)))))
         (0 0)))
       (@1
        (BoundDeclaration
         ((type_expr ((@1 (Type Bool)))) (name b)
          ...
          (init_expr
           ((@1
             (Lambda (@1 (Type Int))
              ((@1
                (BoundDeclaration
                 ((type_expr ((@1 (Type Int)))) (name x) (init_expr ()))
                 (0 1))))
              (@1
               (BoundFrame 2
                ((@1
                  (BoundDeclaration
                   ((type_expr ((@1 (Type Int)))) (name y)
          ...
          (init_expr
           ((@1
             (Lambda (@1 (Type Int))
              ((@1
                (BoundDeclaration
                 ((type_expr ((@1 (Type Int)))) (name n) (init_expr ()))
                 (0 1))))
              (@1
               (BoundFrame 1
                ((@1
